...
for brayen in range(10000):
    rr = random.randint
    rc = random.choice
    u1 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}.{str(rr(0,9))}; Pixel {str(rr(1,10))}XL Build/RPB3.{str(rr(1111111, 2100000))}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    u2 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}.{str(rr(0,9))}; Galaxy {rc(['S10', 'S20', 'S21', 'Note10', 'Note20'])} Build/RPB3.{str(rr(1111111, 2100000))}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    u3 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}.{str(rr(0,9))}; One {rc(['A9', 'A10', 'A11', 'X', 'X+', 'X2'])} Build/RPB3.{str(rr(1111111, 2100000))}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    u4 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}.{str(rr(0,9))}; Xperia {rc(['XZ', 'XZ1', 'XZ2', 'XZ3', '5'])} Build/RPB3.{str(rr(1111111, 2100000))}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    u5 = f"Mozilla/5.0 (Linux; Android {str(rr(4,12))}.{str(rr(0,9))}; Moto {rc(['G7', 'G8', 'G9', 'X4'])} Build/RPB3.{str(rr(1111111, 2100000))}) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
